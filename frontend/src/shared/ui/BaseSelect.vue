...
<template>
  <div
    ref="rootRef"
    class="ft-select"
    :class="[{ 'is-open': open, 'has-error': error, 'is-disabled': disabled }, direction]"
  >
...
.ft-select__button:hover,
.ft-select.is-open .ft-select__button {
  border-color: #ff3f4d;
  box-shadow: 0 0 0 5px rgba(255, 63, 77, .12);
  background: #fff;
}

.ft-select.has-error .ft-select__button {
  border-color: #ff3f4d;
  box-shadow: 0 0 0 5px rgba(255, 63, 77, .10);
}

.ft-select.is-disabled {
  opacity: .55;
  pointer-events: none;
}

.ft-select__value.muted {
  color: #94a3b8;
}
...
.ft-select.is-open .ft-select__chevron {
...
.ft-select__dropdown {
  ...
  background: #fff;
  border: 1px solid #dbe4ef;
  box-shadow: 0 24px 60px rgba(5, 11, 26, .20);
}

.ft-select__dropdown::-webkit-scrollbar {
  width: 8px;
}

.ft-select__dropdown::-webkit-scrollbar-thumb {
  border-radius: 999px;
  background: #cbd5e1;
}
...
.ft-select__option strong {
  display: block;
  font-size: 16px;
  font-weight: 900;
}

.ft-select__option small {
  display: block;
  margin-top: 4px;
  color: #687890;
  font-size: 12px;
...
.ft-select__option.active small {
  color: rgba(255, 255, 255, .82);
}

.ft-select__option em {
  font-style: normal;
  font-size: 11px;
  font-weight: 900;
  padding: 6px 9px;
